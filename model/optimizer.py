...
class ScheduledOptim:
    ...
    def __init__(self, model, fusion_model, adapter, train_config, model_config, current_step):

        self._optimizer = torch.optim.Adam([
            {'params':model.parameters(), 'betas':train_config["optimizer"]["betas"], 'eps':train_config["optimizer"]["eps"], 'weight_decay':train_config["optimizer"]["weight_decay"]},
